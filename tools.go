...
// PushJSONToRemote posts arbitrary data to some URL as JSON, and returns response, status code and error if any.
// The final parameter, client is optional. If none is specified, we use standard http.Client.
